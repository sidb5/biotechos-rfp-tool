...
export default async function QuotePage({ params }: { params: { id: string } }) {
  ...
  const { data: proposal } = await supabase
    .from('proposals')
    .select('id, cro_id, rfp_id, status, quote_data, share_token, share_enabled, share_views, engagement_id, outcome, outcome_date, outcome_notes, contract_value, loss_reason, gap_citations')
    .eq('id', proposalId)
    .single();
