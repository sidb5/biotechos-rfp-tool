...
function ScoreBadge({ score }: { score: number }) {
  const color =
    score >= 80 ? 'text-green-700 border-green-200 bg-green-50' :
  ...
  return parts.map((part, i) => {
    ...
    if (part.startsWith('[TO BE SPECIFIED')) {
      return (
        <mark
          key={`${keyPrefix}-m${i}`}
          className="bg-amber-100 text-amber-700 border border-amber-300 rounded px-1 py-0.5 font-mono text-xs font-semibold not-italic"
        >
          {part}
        </mark>
      );
...
function RenderedSection({ text }: { text: string }) {
  ...
  return (
    <div className="space-y-2.5 text-sm text-gray-700 leading-relaxed font-sans">
      {blocks.map((block, bi) => {
        ...
        if (first.startsWith('# ')) {
          return (
            <h3 key={bi} className="text-base font-bold text-gray-900 mt-3 mb-0.5">
        ...
        if (first.startsWith('## ')) {
          return (
            <h4 key={bi} className="text-sm font-semibold text-gray-800 mt-2 mb-0.5">
      ...
      <div className="mx-auto max-w-6xl px-5 py-8 space-y-6">
        ...
        <header>
          <nav className="mb-2 text-xs text-gray-500">
            ...
            <span className="mx-1.5">/</span>
            <span className="text-gray-500">RFP</span>
          </nav>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {hasRfp && (
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="rounded-xl border border-gray-200 px-4 py-2 text-sm text-gray-500 hover:border-gray-400 hover:text-gray-900 transition-colors"
              ...
              {hasRfp && (
                <a
                  ...
                  className="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:border-blue-600 hover:text-blue-700"
                >
                  Send RFP →
                </a>
              )}
            ...
            {showContextPanel && (
              <div className="px-4 pb-4 space-y-4 border-t border-indigo-800/30 pt-4">
                ...
                <div className="rounded-lg bg-indigo-900/20 border border-indigo-800/30 px-3 py-2 text-xs text-indigo-400">
                  ...
                  <span className="bg-blue-50 text-blue-700 px-1 rounded">+ RFP</span> in meeting debriefs are shown here.
                  ...
                  <span className="bg-amber-50 text-amber-700 px-1 rounded font-mono">[TO BE SPECIFIED]</span>{' '}
        ...
        {contextNotes.length === 0 && hasRfp && (
          <div className="rounded-xl border border-gray-100 bg-white px-4 py-3 flex items-start gap-3">
            <span className="text-gray-400 text-lg mt-0.5">💡</span>
            <div className="text-xs text-gray-500 space-y-0.5">
              <p className="text-gray-700 font-medium">No meeting context yet</p>
              <p>
        ...
        {hasRfp && score < 60 && (
          <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-amber-700">Completeness score below 60</p>
        ...
        {/* ── Empty state ── */}
        {!hasRfp && !generating && (
          <div className="rounded-xl border border-dashed border-gray-200 bg-white px-8 py-20 text-center">
            <p className="text-2xl mb-3">📄</p>
            <h2 className="text-base font-semibold text-gray-900 mb-2">No RFP generated yet</h2>
                ...
                return (
                  <div
                    ...
                    className={`rounded-lg border px-3 py-2 text-center transition-all ${
                      st === 'done'       ? 'border-green-200 bg-green-50 text-green-700' :
                      st === 'generating' ? 'border-blue-200 bg-blue-50 text-blue-700' :
                      st === 'error'      ? 'border-red-200 bg-red-50 text-red-700' :
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-[11px] leading-tight transition-colors flex items-center justify-between gap-1 ${
                      activeSection === key
                        ? 'bg-blue-600/20 text-blue-700 font-medium'
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <div>
                  <h2 className="text-base font-semibold text-gray-900">
                    ...
                    {hasGaps && (
                      <span className="ml-2 rounded-full bg-amber-50 text-amber-700 text-[10px] font-normal px-2 py-0.5 border border-amber-200">
                ...
                <div className="flex items-center gap-2 shrink-0 flex-wrap">
                  ...
                  {displaySections[activeSection] && (
                    <button
                      ...
                      className="text-[11px] rounded-lg border border-gray-200 px-2.5 py-1 text-gray-500 hover:text-indigo-700 hover:border-indigo-200 transition-colors disabled:opacity-50"
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 text-xs text-gray-500 transition-colors hover:border-blue-200 hover:text-blue-700 disabled:opacity-50"
                  >
              ...
              {hasGaps && (
                <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 space-y-2">
                  ...
                  <ul className="space-y-2">
                    {currentGaps.map((g, i) => (
                      <li key={i} className="rounded-lg bg-amber-100 px-3 py-2 text-xs">
                        <span className="font-mono font-semibold text-amber-700">{g.placeholder}</span>
                        <p className="text-amber-600 mt-1 leading-relaxed text-[11px]">
              ...
              <div className="flex items-center justify-between">
                <div className="flex rounded-lg border border-gray-200 overflow-hidden text-xs">
                  <button
                    ...
                    className={`px-3 py-1.5 transition-colors ${!previewMode ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-500 hover:text-gray-700'}`}
                  >
                    ✏ Edit
                  </button>
                  <button
              ...
              {previewMode ? (
                ...
                <textarea
                  ...
                  rows={24}
                  className={`w-full resize-y rounded-xl border px-5 py-4 text-sm text-gray-800 leading-relaxed focus:outline-none focus:ring-1 font-mono bg-white ${
                    hasGaps
                  ...
                  return (
                    <>
                      <button
                        ...
                        disabled={!prev}
                        className="text-xs text-gray-500 hover:text-gray-700 transition-colors disabled:opacity-30"
                      >
